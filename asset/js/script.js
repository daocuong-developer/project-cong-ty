...
const transitions={
    ...
    "vi": {
      ...
      "about": "Thông tin",
      "contact": "Liên hệ",
      "homecontent": "Chào mừng đến với TopRate VietNam",
      "homecontent2": "Chúng tôi là một công ty công nghệ có trụ sở tại Việt Nam, chuyên vềTư vấn & Phát triển Phần mềm. Được thành lập vào năm 2019 bởi một nhómcủa các chuyên gia CNTT có kinh nghiệm và niềm đam mê lớn đối với công nghệ.Công ty chúng tôi cung cấp các giải pháp kỹ thuật tiên tiến đã và đang giúp đỡ rất nhiều khách hàng tại Việt Nam và trên thế giới. Chúng tôi tự hào vềchất lượng công việc của chúng tôi và không ngừng tìm kiếm những cách thức mới để cải thiện bí quyết và năng lực của chúng tôi.",
      "explore": "Xem thêm",
